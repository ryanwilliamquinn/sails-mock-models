...
describe('test mocks', function() {
  ...
  it('should call a function to get the return value', function(done) {

    var countStub = mock.mockModel(User, 'count', function() {
        return 5;
    });
  ...
  it('should pass criteria arguments correctly to the return function', function(done) {
    var countStub = mock.mockModel(User, 'count', function(criteria) {
    ...
    User.count({
      ...
      .then(function(results) {
        countStub.restore();
        results.should.eql('anything');
        countStub.calledOnce.should.be.true;
      })
      .done(done, done);
  });

  it('should pass where arguments correctly to the return function', function(done) {
    var countStub = mock.mockModel(User, 'count', function(criteria) {
        return criteria.name;
    });
  ...
  it('should pass chained where arguments correctly to the return function', function(done) {
    var countStub = mock.mockModel(User, 'count', function(criteria) {
        return criteria.name;
    });
